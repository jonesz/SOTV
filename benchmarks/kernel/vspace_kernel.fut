...
module K_vspace_2 = mk_kernel_se f32 vector_2 vspace_2_f32 {
  def l = 2f32
  def sigma = 2f32
}

module K_vspace_3 = mk_kernel_se f32 vector_3 vspace_3_f32 {
  def l = 2f32
  def sigma = 2f32
}

module K_vspace_5 = mk_kernel_se f32 vector_5 vspace_5_f32 {
  def l = 2f32
  def sigma = 2f32
}

module K_vspace_10 = mk_kernel_se f32 vector_10 vspace_10_f32 {
  def l = 2f32
  def sigma = 2f32
}

module K_vspace_100 = mk_kernel_se f32 vector_100 vspace_100_f32 {
  def l = 2f32
  def sigma = 2f32
}
...
entry bench_vspace_10_f32 x x' =
  ...
  let x' = map (vector_10.from_array) x'
  in map2 (K_vspace_10.kernel) x x'
...
entry bench_vspace_100_f32 x x' =
  ...
  let x' = map (vector_100.from_array) x'
  in map2 (K_vspace_100.kernel) x x'
